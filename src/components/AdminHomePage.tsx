...
import styles from "./HomePage.module.css"; // same CSS as HomePage
...
const AdminHomePage: React.FC = () => {
  ...
  const currentlyRunning: Movie[] = filteredMovies.filter(
    (movie) => movie.status === "running"
  );
  const comingSoon: Movie[] = filteredMovies.filter(
